...
<head>
  ...
  <link rel="stylesheet" href="frontend\css\projets.css">
<style>
.navbar-fixed-top {
  top: auto;
}
...
<section class="projects-page py-5">
        <div class="container">
            <h2 class="text-center mb-4">Nos Projets de Recherche</h2>
            <p class="text-center mb-4">Découvrez tous nos travaux et projets</p>
           ...
           <?php
               ...
               {
                    $conn = connectDB();
                        $sql = "SELECT id, titre, description FROM projets";
                     ...
                     if ($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()) {
                                   ...
                                   <div class="card shadow-sm border-light">
                                          <div class="card-body">
                                            ...
                                            <p class="card-text">'. $row["description"] .'</p>
                                             <a href="detail_projet.php?id=' . $row["id"] . '" class="btn btn-primary">Voir Plus</a>
                                          </div> 
                                         </div> 
                                        </div>';
                             }
                           ...
                           {
                                 echo '<p class="text-center w-100">Aucune projet trouvé dans la base de données</p>';
                           }
                          $conn->close();
                   }
                    else
                    {
                         echo "<p class='text-center w-100'>Connectez-vous pour pouvoir visualiser nos différents projets</p>";
                    }
